...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("POIApp.POIListActivity, POIApp", POIListActivity.class, __md_methods);
	}
	...
	public POIListActivity ()
	{
		...
		if (getClass () == POIListActivity.class)
			mono.android.TypeManager.Activate ("POIApp.POIListActivity, POIApp", "", this, new java.lang.Object[] {  });
	}
